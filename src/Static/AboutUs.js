        ...
        <div class="p-5 bg-gray-100" alt="Work as Merchant">
            <section class="max-w-screen-lg m-auto grid grid-cols-1 md:grid-cols-2">
                ...
                <article class="flex flex-col place-content-center p-5">
                        ...
                        <button type="button" name="button" class="bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded">
                            Sign here
                        </button>
                </article>
            </section>
